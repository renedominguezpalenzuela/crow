...
//-------------------------------------------------------------------------
//OK:  Datos del kingdom y del user
//-------------------------------------------------------------------------
function dibujarBotonesUpgradeRepair(team, recursos) {
    ...
    var fondos_necesarios_upgrade =1000000; //1000000;
    var fondos_necesarios_repair = 1000; //1000
...
//-------------------------------------------------------------------------
//OK:    Datos del Castillo
//-------------------------------------------------------------------------
function setCastilloData(datos_castillo) {   
    $('#castle_id').html(datos_castillo.castle_id)
...
function dibujarEdificiosenHTML(buildings) {
    ...
    for (unedificio of buildings) {
        if (unedificio.building_name != "Barrack") {
            ...
            //si no es el main_castle dibujarlo
            if (!unedificio.main_castle) {
              //TODO: poner resto de los datos del edificio
              //TODO: poner botones de reparar y upgrade
                lista_edificios_html.append(
                    '<div class="card">' +
                        '<div class="card-header-primary">' +
                           '<h5>' + unedificio.building_name + '</h5>' +
                        '</div>' +
                        '<div class="card-body">' +
                        '<p><span>Building ID: '+unedificio.building_id.toString()+'</span></p>'+
